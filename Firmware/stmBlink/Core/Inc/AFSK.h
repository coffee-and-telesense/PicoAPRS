...
//#define LED_TX_INIT() do { LED_DDR |= 1; } while (0)
//#define LED_TX_ON()   do { LED_PORT |= 1; } while (0)
//#define LED_TX_OFF()  do { LED_PORT &= ~1; } while (0)

//#define LED_RX_INIT() do { LED_DDR |= 2; } while (0)
//#define LED_RX_ON()   do { LED_PORT |= 2; } while (0)
//#define LED_RX_OFF()  do { LED_PORT &= ~2; } while (0)
